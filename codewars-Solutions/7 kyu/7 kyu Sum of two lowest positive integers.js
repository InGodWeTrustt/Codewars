...
/**
 *  Найти сумму двух наименьших значений в массиве чисел
 * @param {*} numbers массив чисео
 * @returns сумма чисел
 */
function sumTwoSmallestNumbers(numbers) {
    let sortedArrByAscending = numbers.sort((a, b) => a - b);
    let [min1, min2] = sortedArrByAscending
    return min1 + min2
}
