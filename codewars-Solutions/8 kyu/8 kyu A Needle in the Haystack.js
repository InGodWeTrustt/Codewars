function findNeedle(haystack) {
    const index = haystack.findIndex(stack => typeof stack === 'string' ? stack.includes('needle') : false);
    return index > -1 ? `found the needle at position ${index}` : `Your function didn't return anything`;
}
